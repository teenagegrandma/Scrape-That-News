...
var makeDate = rquire('../scripts/date.js');
...
exports.save = funciton(data, cb); {
	...
	//maek a newNote with the note model, saving the apropriate info
...
//export this funciton as gather (cb = callback, data = an article obj)
...
//export this funtion as delete (data = article, cb = callback)
