$(document).ready(function() {
	...
	$('#seek-box').click(function() {
		//grab the scraped article and populate
		populate();
		$('.container').show();
		$('#seek-box').hide();
	});
...
//these variables leet the fancy cube on our page function properly
var state = 0;
...
var populate = function() {
	...
	$.getJSON('/check', function(data) {
		...
		//save the latest article's data and save it to dataDate
...
//This funciton handles typing animations
var typeIt = function() {
	...
	var headling = mongoData[dataCount].headline;
